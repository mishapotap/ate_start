        ...
        <div className='aes'>
            ...
            <Modal isOpened={isPumpOpened} onClose={() => {setIsPumpOpened(false)}}>
                <div>
                    ...
                    <h3>Градирня</h3>
                    <img className='modal__image' src={Gradeer} alt="Градирня" />
                    <div className='text'>
            ...
            <Modal isOpened={isRdesOpened && step !== 'a3'} onClose={() => {setIsRdesOpened(false)}}>
                <div>
                    <div className='modal__stage-subtitle'><div>А0</div>подэтап</div>
                    <h3>РДЭС/БДЭС (UBN)</h3>
                    <img className='modal__image' src={RdesBdes} alt="РДЭС/БДЭС" />
                    <div className='text'>
            ...
            <Modal isOpened={isElectric1Opened} onClose={() => {setIsElectric1Opened(false)}}>
                <div>
                    ...
                    <img className='modal__image' src={ElectricBuild} alt="Электрические здания" />
                    <div className='text'>
            ...
            <Modal isOpened={isCleaningOpened} onClose={() => {setIsCleaningOpened(false)}}>
                <div>
                    ...
                    <img className='modal__image' src={ChemicalCleaning} alt="Здание химводоочистки" />
                    <div className='text'>
            ...
            <Modal isOpened={isCleaning2Opened} onClose={() => {setIsCleaning2Opened(false)}}>
                <div>
                    ...
                    <img className='modal__image' src={CleaningBuild} alt="Очистные сооружения" />
                    <div className='text'>
            ...
            <Modal isOpened={isPoolsOpened} onClose={() => {setIsPoolsOpened(false)}}>
                <div>
                    ...
                    <img className='modal__image' src={Pool} alt="Брызгальные бассейны" />
                    <div className='text'>
            ...
            >
                <div>
                    ...
                    <img className='modal__image' src={ReactorBuild} alt="Здание реактора" />
                    <div className='text'>
            ...
            <Modal isOpened={isSecondReactorOpened} onClose={() => {setIsSecondReactorOpened(false)}}>
                <div>
                    ...
                    <img className='modal__image' src={ReactorHelpBuild} alt="Вспомогательное реакторное здание" />
                    <div className='text'>
            ...
            <Modal isOpened={isTurbineOpened} onClose={() => {setIsTurbineOpened(false)}}>
                <div>
                    ...
                    <img className='modal__image' src={TurbinBuild} alt="Здание турбины" />
                    <div className='text'>
